...
2.5) Я переместил катлог newdir в каталог ski.plases и переименовал его в plans.
...
![Права my_os](image/5-9.png){#fig:09 width=70%}
...
![перемещение в play](image/5-13.png){#fig:013 width=70%}
